...
unsigned int nTargetSpacing = 2 * 60; // 2 min

static const int64_t nInterval = nTargetTimespan / nTargetSpacing;
static const int64_t nDiffChangeTarget = 1;

unsigned int nStakeMinAge = 60; // 3 min
unsigned int nStakeMaxAge = -1; // unlimited

unsigned int nModifierInterval = 30;
...
const string strMessageMagic = "Bud Signed Message:\n";
...
// miner's coin base reward // total coin count will equal about 1 billion.
...
bool CBlock::SignBlock(CWallet& wallet, int64_t nFees)
{
    ...
    {
        //printf("StakeMiner: !vtx[0].vout[0].IsEmpty()\n");
        return false;
    }
    ...
    if (IsProofOfStake())
    {
        //printf("StakeMiner: IsProofOfStake()\n");    
        return true;
    }
    ...
    if (nSearchTime > nLastCoinStakeSearchTime)
    {
        if (wallet.CreateCoinStake(wallet, nBits, nSearchTime-nLastCoinStakeSearchTime, nFees, txCoinStake, key))
        {
    		...
    		//printf("StakeMiner: append a signature to our block\n");                    
    ...
    //printf("StakeMiner: return false\n");    
    return false;
}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Bud", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bnTrustedModulus.SetHex("");
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Bud";
        CTransaction txNew;
        txNew.nTime = 1516213662;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        // debug print
        assert(block.hashMerkleRoot == uint256("0xdfc10efd3276b9e1a4d12028c69c4ffd44f9bf20935b2cfd7fc426a650cdd10f"));
        block.print();
    ...
    string strPubKey = "040a952898657e3187138aabad4c2d31bc20fa0d433b4bb735999becb6cfd56ce88c8efbcb0808c9ded327ec77461ac0ce5b1783305ab15322a107a5cdd33d5a20";
...
unsigned char pchMessageStart[4] = { 0xb5, 0xa1, 0xc2, 0xdb };
